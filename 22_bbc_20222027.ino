...
#define _DUTY_MAX 2195 // 2000
#define _DUTY_NEU 1510 // 1500
#define _DUTY_MIN 734 // 1000

#define _SERVO_ANGLE_DIFF  95  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 541 + -1.6*a_value + 1.19E-03*a_value*a_value;
}
